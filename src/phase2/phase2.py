import torch
import os
from phase2_model import ModelBasic, ModelLinkPred, ModelAtten, ModelLocalLinkPred
from phase2_dataset import dataset
import numpy
from utils import *
...
parser.add_argument('--modelPhase2',type=str,default='none', help='Use ModelGCN or ModelLinkPred or ModelLocalLinkPred or ModelGCN_Atten')
...
result_folder=f'../../results_phase2_rl/{args.train}_{args.embedding}_{args.anchors}_{args.norm}_{model_name}_{num_layers}_{args.modelPhase2}_{args.iter_update_params}_{args.initial_type}_{args.initial_order}_{args.scoring_func}_{args.node_select}_{num_perturbation}_{args.node_select_heuristic}_{args.pool}_{args.update_reward}_{args.hops}_{args.cuttype}_{args.gamma}'
...
if wandb_flag:
    wandb.init(project="phase2_rl", name=f"{args.train}_{args.embedding}_{args.anchors}_{args.norm}_{model_name}_{num_layers}_{args.modelPhase2}_{args.iter_update_params}_{args.initial_type}_{args.initial_order}_{args.scoring_func}_{args.node_select}_{num_perturbation}_{args.node_select_heuristic}_{args.pool}_{args.update_reward}_{args.hops}_{args.cuttype}_{args.gamma}", config=args,entity='mincuts')

model_folder=f'../../models_phase2_rl/{args.train}_{args.embedding}_{args.anchors}_{args.norm}_{model_name}_{num_layers}_{args.modelPhase2}_{args.iter_update_params}_{args.initial_type}__{args.initial_order}_{args.scoring_func}_{args.node_select}_{num_perturbation}_{args.node_select_heuristic}_{args.pool}_{args.update_reward}_{args.hops}_{args.cuttype}_{args.gamma}'

# model_folder=f'../../models_phase2_rl/{args.train}_{args.embedding}_{args.norm}_{model_name}_{num_layers}_{args.modelPhase2}_{args.iter_update_params}_{args.initial_type}'
...
if args.modelPhase2=='ModelBasic':
...
elif args.modelPhase2=='ModelLinkPred':
...
elif args.modelPhase2=='ModelAtten':
...
elif args.modelPhase2=='ModelLocalLinkPred':
